...
clip2.ClipType.Origin = [xValue, yValue, zValuePercent]
...
clip3.ClipType.Origin = [xValue, yValue, zValueFix]
...
# export view
ExportView('/Users/yhao/Downloads/toppercent.csv', view=spreadSheetView1)

# show data in view
clip3Display_1 = Show(clip3, spreadSheetView1, 'SpreadSheetRepresentation')

# export view
ExportView('/Users/yhao/Downloads/topfix.csv', view=spreadSheetView1)
