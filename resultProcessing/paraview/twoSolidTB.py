...
# create a new 'Clip'
clip1 = Clip(registrationName='Surface', Input=calculator2)
...
# create a new 'Clip'
clip2 = Clip(registrationName='solid1', Input=clip1)
...
# create a new 'Extract Selection'
extractSelection3 = ExtractSelection(registrationName='HighestSolid1', Input=clip2)

# Get index information for maximum coordZ point
pointD1 = paraview.servermanager.Fetch(extractSelection2)
xValue1 = pointD1.GetPoint(0)[0]
yValue1 = pointD1.GetPoint(0)[1]
maxZ1 = pointD1.GetPoint(0)[2]
zValue10top1= maxZ1*9/10
zValue10bottom1= maxZ1*1/10
zValue3top1 = maxZ1*2/3
zValue3bottom1 = maxZ1*1/3

# create a new 'Clip'
clip3 = Clip(registrationName='1top10I', Input=clip2)

# Properties modified on clip3.ClipType
clip3.ClipType.Origin = [xValue1, yValue1, zValue10top1]
...
# create a new 'Clip'
clip4 = Clip(registrationName='1middle10', Input=clip3)

# Properties modified on clip4.ClipType
clip4.ClipType.Origin = [xValue1, yValue1, zValue10bottom1]
...
# create a new 'Clip'
clip5 = Clip(registrationName='1bottom10', Input=clip2)

# Properties modified on clip5.ClipType
clip5.ClipType.Origin = [xValue1, yValue1, zValue10bottom1]
...
# create a new 'Clip'
clip6 = Clip(registrationName='1top3', Input=clip2)

# Properties modified on clip6.ClipType
clip6.ClipType.Origin = [xValue1, yValue1, zValue3top1]
...
# create a new 'Clip'
clip7 = Clip(registrationName='1top3I', Input=clip2)

# Properties modified on clip7.ClipType
clip7.ClipType.Origin = [xValue1, yValue1, zValue3top1]
...
# create a new 'Clip'
clip8 = Clip(registrationName='1middle3', Input=clip7)

# Properties modified on clip8.ClipType
clip8.ClipType.Origin = [xValue1, yValue1, zValue3bottom1]
...
# create a new 'Clip'
clip9 = Clip(registrationName='1bottom3', Input=clip2)

# Properties modified on clip9.ClipType
clip9.ClipType.Origin = [xValue1, yValue1, zValue3bottom1]
...
# show data in view
clip5Display_1 = Show(clip9, spreadSheetView1, 'SpreadSheetRepresentation')
...
# export view
ExportView('/Users/yhao/Downloads/1middle10.csv', view=spreadSheetView1)

# show data in view
clip5Display_1 = Show(clip5, spreadSheetView1, 'SpreadSheetRepresentation')

# export view
ExportView('/Users/yhao/Downloads/1bottom10.csv', view=spreadSheetView1)

# show data in view
clip6Display_1 = Show(clip6, spreadSheetView1, 'SpreadSheetRepresentation')

# export view
ExportView('/Users/yhao/Downloads/1top3.csv', view=spreadSheetView1)

# show data in view
clip8Display_1 = Show(clip8, spreadSheetView1, 'SpreadSheetRepresentation')

# export view
ExportView('/Users/yhao/Downloads/1middle3.csv', view=spreadSheetView1)

# show data in view
clip9Display_1 = Show(clip9, spreadSheetView1, 'SpreadSheetRepresentation')

# export view
ExportView('/Users/yhao/Downloads/1bottom3.csv', view=spreadSheetView1)


#================================================================
# Start process solid2
#================================================================
...
# create a new 'Clip'
clip2 = Clip(registrationName='solid2', Input=clip1)
...
# create a new 'Extract Selection'
extractSelection3 = ExtractSelection(registrationName='HighestSolid2', Input=clip2)

# Get index information for maximum coordZ point
pointD2 = paraview.servermanager.Fetch(extractSelection2)
xValue2 = pointD2.GetPoint(0)[0]
yValue2 = pointD2.GetPoint(0)[1]
maxZ2 = pointD2.GetPoint(0)[2]
zValue10top2 = maxZ2*9/10
zValue10bottom2 = maxZ2*1/10
zValue3top2 = maxZ2*2/3
zValue3bottom2 = maxZ2*1/3

# create a new 'Clip'
clip3 = Clip(registrationName='2top10I', Input=clip2)

# Properties modified on clip3.ClipType
clip3.ClipType.Origin = [xValue2, yValue2, zValue10top2]
clip3.ClipType.Normal = [0.0, 0.0, 1.0]
...
# create a new 'Clip'
clip4 = Clip(registrationName='2middle10', Input=clip3)

# Properties modified on clip4.ClipType
clip4.ClipType.Origin = [xValue2, yValue2, zValue10bottom2]
clip4.ClipType.Normal = [0.0, 0.0, -1.0]
...
# create a new 'Clip'
clip5 = Clip(registrationName='2bottom10', Input=clip2)

# Properties modified on clip5.ClipType
clip5.ClipType.Origin = [xValue2, yValue2, zValue10bottom2]
clip5.ClipType.Normal = [0.0, 0.0, 1.0]
...
# create a new 'Clip'
clip6 = Clip(registrationName='2top3', Input=clip2)

# Properties modified on clip6.ClipType
clip6.ClipType.Origin = [xValue2, yValue2, zValue3top2]
clip6.ClipType.Normal = [0.0, 0.0, -1.0]
...
# create a new 'Clip'
clip7 = Clip(registrationName='2top3I', Input=clip2)

# Properties modified on clip7.ClipType
clip7.ClipType.Origin = [xValue2, yValue2, zValue3top2]
clip7.ClipType.Normal = [0.0, 0.0, 1.0]
...
# create a new 'Clip'
clip8 = Clip(registrationName='2middle3', Input=clip7)

# Properties modified on clip8.ClipType
clip8.ClipType.Origin = [xValue2, yValue2, zValue3bottom2]
clip8.ClipType.Normal = [0.0, 0.0, -1.0]
...
# create a new 'Clip'
clip9 = Clip(registrationName='2bottom3', Input=clip2)

# Properties modified on clip9.ClipType
clip9.ClipType.Origin = [xValue2, yValue2, zValue3bottom2]
clip9.ClipType.Normal = [0.0, 0.0, 1.0]
...
# export view
ExportView('/Users/yhao/Downloads/2middle10.csv', view=spreadSheetView1)

# show data in view
clip5Display_1 = Show(clip5, spreadSheetView1, 'SpreadSheetRepresentation')

# export view
ExportView('/Users/yhao/Downloads/2bottom10.csv', view=spreadSheetView1)

# show data in view
clip6Display_1 = Show(clip6, spreadSheetView1, 'SpreadSheetRepresentation')

# export view
ExportView('/Users/yhao/Downloads/2top3.csv', view=spreadSheetView1)

# show data in view
clip8Display_1 = Show(clip8, spreadSheetView1, 'SpreadSheetRepresentation')

# export view
ExportView('/Users/yhao/Downloads/2middle3.csv', view=spreadSheetView1)

# show data in view
clip9Display_1 = Show(clip9, spreadSheetView1, 'SpreadSheetRepresentation')

# export view
ExportView('/Users/yhao/Downloads/2bottom3.csv', view=spreadSheetView1)
