...
fig, ax = plt.subplots()
ax.plot(time[0:6],np.mean(grH800,axis=0),'^--', color=color1, markersize=8, label='800 1/s')
...
ax.plot(time[0:6],np.mean(grH1600,axis=0),'o--', color=color2, markersize=8,label='1600 1/s')
...
ax.plot(time[0:4],np.mean(grH4000,axis=0),'s--', color=color3, markersize=8,label='4000 1/s')
...
fig, ax = plt.subplots()
ax.plot(time[0:6],np.mean(grA800,axis=0),'^--', color=color1, markersize=8, label='800 1/s')
...
ax.plot(time[0:6],np.mean(grA1600,axis=0),'o--', color=color2, markersize=8,label='1600 1/s')
...
ax.plot(time[0:4],np.mean(grA4000,axis=0),'s--', color=color3, markersize=8,label='4000 1/s')
...
ax.set_xlabel('time $[min]$',fontsize=fontsize)
plt.title('Average growth rate -- attachment surface area',fontsize=fontsize)
...
fig, ax = plt.subplots()
ax.plot(time[0:6],np.mean(grV800,axis=0),'^--', color=color1, markersize=8, label='800 1/s')
...
ax.plot(time[0:6],np.mean(grV1600,axis=0),'o--', color=color2, markersize=8, label='1600 1/s')
...
ax.plot(time[0:4],np.mean(grV4000,axis=0),'s--', color=color3, markersize=8, label='4000 1/s')
