...
## High density
highvf800d11min = np.array([vf800d11min[vf800d11min>0.5]])
highvf800d12min = np.array([vf800d12min[vf800d12min>0.5]])
highvf800d14min = np.array([vf800d14min[vf800d14min>0.5]])
highvf800d16min = np.array([vf800d16min[vf800d16min>0.5]])
highvf800d19min = np.array([vf800d19min[vf800d19min>0.5]])
highvf800d112min = np.array([vf800d112min[vf800d112min>0.5]])

highvf800d21min = np.array([vf800d21min[vf800d21min>0.5]])
highvf800d22min = np.array([vf800d22min[vf800d22min>0.5]])
highvf800d24min = np.array([vf800d24min[vf800d24min>0.5]])
highvf800d26min = np.array([vf800d26min[vf800d26min>0.5]])
highvf800d29min = np.array([vf800d29min[vf800d29min>0.5]])
highvf800d212min = np.array([vf800d212min[vf800d212min>0.5]])

highvf800d31min = np.array([vf800d31min[vf800d31min>0.5]])
highvf800d32min = np.array([vf800d32min[vf800d32min>0.5]])
highvf800d34min = np.array([vf800d34min[vf800d34min>0.5]])
highvf800d36min = np.array([vf800d36min[vf800d36min>0.5]])
highvf800d39min = np.array([vf800d39min[vf800d39min>0.5]])
highvf800d312min = np.array([vf800d312min[vf800d312min>0.5]])

highvf800d51min = np.array([vf800d51min[vf800d51min>0.5]])
highvf800d52min = np.array([vf800d52min[vf800d52min>0.5]])
highvf800d54min = np.array([vf800d54min[vf800d54min>0.5]])
highvf800d56min = np.array([vf800d56min[vf800d56min>0.5]])
highvf800d59min = np.array([vf800d59min[vf800d59min>0.5]])
highvf800d512min = np.array([vf800d512min[vf800d512min>0.5]])

highvf800d61min = np.array([vf800d61min[vf800d61min>0.5]])
highvf800d62min = np.array([vf800d62min[vf800d62min>0.5]])
highvf800d64min = np.array([vf800d64min[vf800d64min>0.5]])
highvf800d66min = np.array([vf800d66min[vf800d66min>0.5]])
highvf800d69min = np.array([vf800d69min[vf800d69min>0.5]])
highvf800d612min = np.array([vf800d612min[vf800d612min>0.5]])

highvf1600d21min = np.array([vf1600d21min[vf1600d21min>0.5]])
highvf1600d22min = np.array([vf1600d22min[vf1600d22min>0.5]])
highvf1600d24min = np.array([vf1600d24min[vf1600d24min>0.5]])
highvf1600d26min = np.array([vf1600d26min[vf1600d26min>0.5]])
highvf1600d29min = np.array([vf1600d29min[vf1600d29min>0.5]])
highvf1600d212min = np.array([vf1600d212min[vf1600d212min>0.5]])

highvf1600d31min = np.array([vf1600d31min[vf1600d31min>0.5]])
highvf1600d32min = np.array([vf1600d32min[vf1600d32min>0.5]])
highvf1600d34min = np.array([vf1600d34min[vf1600d34min>0.5]])
highvf1600d36min = np.array([vf1600d36min[vf1600d36min>0.5]])
highvf1600d39min = np.array([vf1600d39min[vf1600d39min>0.5]])
highvf1600d312min = np.array([vf1600d312min[vf1600d312min>0.5]])

highvf1600d41min = np.array([vf1600d41min[vf1600d41min>0.5]])
highvf1600d42min = np.array([vf1600d42min[vf1600d42min>0.5]])
highvf1600d44min = np.array([vf1600d44min[vf1600d44min>0.5]])
highvf1600d46min = np.array([vf1600d46min[vf1600d46min>0.5]])
highvf1600d49min = np.array([vf1600d49min[vf1600d49min>0.5]])
highvf1600d412min = np.array([vf1600d412min[vf1600d412min>0.5]])

highvf1600d51min = np.array([vf1600d51min[vf1600d51min>0.5]])
highvf1600d52min = np.array([vf1600d52min[vf1600d52min>0.5]])
highvf1600d54min = np.array([vf1600d54min[vf1600d54min>0.5]])
highvf1600d56min = np.array([vf1600d56min[vf1600d56min>0.5]])
highvf1600d59min = np.array([vf1600d59min[vf1600d59min>0.5]])
highvf1600d512min = np.array([vf1600d512min[vf1600d512min>0.5]])

highvf1600d61min = np.array([vf1600d61min[vf1600d61min>0.5]])
highvf1600d62min = np.array([vf1600d62min[vf1600d62min>0.5]])
highvf1600d64min = np.array([vf1600d64min[vf1600d64min>0.5]])
...
highvf4000d34min = np.array([vf4000d34min[vf4000d34min>0.5]])
highvf4000d36min = np.array([vf4000d36min[vf4000d36min>0.5]])
highvf4000d39min = np.array([vf4000d39min[vf4000d39min>0.5]])
highvf4000d312min = np.array([vf4000d312min[vf4000d312min>0.5]])

highvf4000d51min = np.array([vf4000d51min[vf4000d51min>0.5]])
highvf4000d52min = np.array([vf4000d52min[vf4000d52min>0.5]])
highvf4000d54min = np.array([vf4000d54min[vf4000d54min>0.5]])
highvf4000d56min = np.array([vf4000d56min[vf4000d56min>0.5]])

highvf4000d61min = np.array([vf4000d61min[vf4000d61min>0.5]])
highvf4000d62min = np.array([vf4000d62min[vf4000d62min>0.5]])
highvf4000d64min = np.array([vf4000d64min[vf4000d64min>0.5]])
highvf4000d66min = np.array([vf4000d66min[vf4000d66min>0.5]])


## Low density
lowvf800d11min = np.array([vf800d11min[vf800d11min<0.5]])
lowvf800d12min = np.array([vf800d12min[vf800d12min<0.5]])
lowvf800d14min = np.array([vf800d14min[vf800d14min<0.5]])
lowvf800d16min = np.array([vf800d16min[vf800d16min<0.5]])
lowvf800d19min = np.array([vf800d19min[vf800d19min<0.5]])
lowvf800d112min = np.array([vf800d112min[vf800d112min<0.5]])

lowvf800d21min = np.array([vf800d21min[vf800d21min<0.5]])
lowvf800d22min = np.array([vf800d22min[vf800d22min<0.5]])
lowvf800d24min = np.array([vf800d24min[vf800d24min<0.5]])
lowvf800d26min = np.array([vf800d26min[vf800d26min<0.5]])
lowvf800d29min = np.array([vf800d29min[vf800d29min<0.5]])
lowvf800d212min = np.array([vf800d212min[vf800d212min<0.5]])

lowvf800d31min = np.array([vf800d31min[vf800d31min<0.5]])
lowvf800d32min = np.array([vf800d32min[vf800d32min<0.5]])
lowvf800d34min = np.array([vf800d34min[vf800d34min<0.5]])
lowvf800d36min = np.array([vf800d36min[vf800d36min<0.5]])
lowvf800d39min = np.array([vf800d39min[vf800d39min<0.5]])
lowvf800d312min = np.array([vf800d312min[vf800d312min<0.5]])

lowvf800d51min = np.array([vf800d51min[vf800d51min<0.5]])
lowvf800d52min = np.array([vf800d52min[vf800d52min<0.5]])
lowvf800d54min = np.array([vf800d54min[vf800d54min<0.5]])
lowvf800d56min = np.array([vf800d56min[vf800d56min<0.5]])
lowvf800d59min = np.array([vf800d59min[vf800d59min<0.5]])
lowvf800d512min = np.array([vf800d512min[vf800d512min<0.5]])

lowvf800d61min = np.array([vf800d61min[vf800d61min<0.5]])
lowvf800d62min = np.array([vf800d62min[vf800d62min<0.5]])
lowvf800d64min = np.array([vf800d64min[vf800d64min<0.5]])
lowvf800d66min = np.array([vf800d66min[vf800d66min<0.5]])
lowvf800d69min = np.array([vf800d69min[vf800d69min<0.5]])
lowvf800d612min = np.array([vf800d612min[vf800d612min<0.5]])

lowvf1600d21min = np.array([vf1600d21min[vf1600d21min<0.5]])
lowvf1600d22min = np.array([vf1600d22min[vf1600d22min<0.5]])
lowvf1600d24min = np.array([vf1600d24min[vf1600d24min<0.5]])
lowvf1600d26min = np.array([vf1600d26min[vf1600d26min<0.5]])
lowvf1600d29min = np.array([vf1600d29min[vf1600d29min<0.5]])
lowvf1600d212min = np.array([vf1600d212min[vf1600d212min<0.5]])

lowvf1600d31min = np.array([vf1600d31min[vf1600d31min<0.5]])
lowvf1600d32min = np.array([vf1600d32min[vf1600d32min<0.5]])
lowvf1600d34min = np.array([vf1600d34min[vf1600d34min<0.5]])
lowvf1600d36min = np.array([vf1600d36min[vf1600d36min<0.5]])
lowvf1600d39min = np.array([vf1600d39min[vf1600d39min<0.5]])
lowvf1600d312min = np.array([vf1600d312min[vf1600d312min<0.5]])

lowvf1600d41min = np.array([vf1600d41min[vf1600d41min<0.5]])
lowvf1600d42min = np.array([vf1600d42min[vf1600d42min<0.5]])
lowvf1600d44min = np.array([vf1600d44min[vf1600d44min<0.5]])
lowvf1600d46min = np.array([vf1600d46min[vf1600d46min<0.5]])
lowvf1600d49min = np.array([vf1600d49min[vf1600d49min<0.5]])
lowvf1600d412min = np.array([vf1600d412min[vf1600d412min<0.5]])

lowvf1600d51min = np.array([vf1600d51min[vf1600d51min<0.5]])
lowvf1600d52min = np.array([vf1600d52min[vf1600d52min<0.5]])
lowvf1600d54min = np.array([vf1600d54min[vf1600d54min<0.5]])
lowvf1600d56min = np.array([vf1600d56min[vf1600d56min<0.5]])
lowvf1600d59min = np.array([vf1600d59min[vf1600d59min<0.5]])
lowvf1600d512min = np.array([vf1600d512min[vf1600d512min<0.5]])

lowvf1600d61min = np.array([vf1600d61min[vf1600d61min<0.5]])
lowvf1600d62min = np.array([vf1600d62min[vf1600d62min<0.5]])
lowvf1600d64min = np.array([vf1600d64min[vf1600d64min<0.5]])
lowvf1600d66min = np.array([vf1600d66min[vf1600d66min<0.5]])
...
lowvf4000d36min = np.array([vf4000d36min[vf4000d36min<0.5]])
lowvf4000d39min = np.array([vf4000d39min[vf4000d39min<0.5]])
lowvf4000d312min = np.array([vf4000d312min[vf4000d312min<0.5]])

lowvf4000d51min = np.array([vf4000d51min[vf4000d51min<0.5]])
lowvf4000d52min = np.array([vf4000d52min[vf4000d52min<0.5]])
lowvf4000d54min = np.array([vf4000d54min[vf4000d54min<0.5]])
lowvf4000d56min = np.array([vf4000d56min[vf4000d56min<0.5]])

lowvf4000d61min = np.array([vf4000d61min[vf4000d61min<0.5]])
lowvf4000d62min = np.array([vf4000d62min[vf4000d62min<0.5]])
lowvf4000d64min = np.array([vf4000d64min[vf4000d64min<0.5]])
lowvf4000d66min = np.array([vf4000d66min[vf4000d66min<0.5]])
